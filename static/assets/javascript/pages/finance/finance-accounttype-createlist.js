    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apifinance-accounttype-api/";
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'account_type_short_name' },
                        { data: 'maximum_credit_limit' },
                        { data: 'account_ledger_code' },
                        { data: 'receivable_ledger' },
                        { data: 'payable_ledger' },
                        { data: 'income_ledger' },
                        { data: 'expense_ledger' },
                        { data: 'is_active' },
...
$(document).ready(function () {
    $('#id_account_ledger_code').select2();
    $('#id_receivable_ledger').select2();
    $('#id_payable_ledger').select2();
    $('#id_income_ledger').select2();
    $('#id_expense_ledger').select2();
});
...
$(function () {
    ...
    $('#dt-table-list').on('click', 'button', function () {
        ...
        try {
            ...
            id = table_row['account_type_code']
        }
        catch (e) {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/finance-accounttype-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
