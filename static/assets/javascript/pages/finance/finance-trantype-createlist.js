    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apifinance-trantype-api/";
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'credit_gl_code' },
                        { data: 'debit_gl_code' },
                        { data: 'transaction_screen' },
                        { data: 'is_active' },
                        { data: 'tran_account_type' },
                        { data: 'debit_allowed' },
                        { data: 'credit_allowed' },
                        { data: 'is_account_required' },
                        {
                            "data": null,
...
$(document).ready(function () {
    $('#id_credit_gl_code').select2();
    $('#id_debit_gl_code').select2();
    $('#id_transaction_screen').select2();
});
