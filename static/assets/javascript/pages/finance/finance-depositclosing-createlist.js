    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                ...
                var search_url = "/apifinance-depositclosing-api/?account_number=" + account_number;
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.form_is_valid) {
                ...
                $('#id_closing_balance').val(data.account_balance);
            } else {
                $('#id_account_balance').val('');
                $('#id_closing_balance').val('');
            }
        }
    })
    return false;
...
function cancel_transaction(id) {
    if (confirm('Are you sure you want to cancel this Transaction?') == true) {
        ...
        $.ajax({
            url: "/finance-depositclosing-cancel/" + id,
            type: "POST",
            success: function (data) {
                if (data.form_is_valid) {
