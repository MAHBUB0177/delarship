...
function save_and_show_report() {
    ...
    var report_data = {
        'p_branch_code': $('#id_branch_code').val(), 'p_supplier_account': $('#id_account_number').val(),
        'p_from_date': $('#id_from_date').val(), 'p_upto_date': $('#id_upto_date').val(),
        'p_product_id': $('#id_product_id').val(), 'p_brand_id': $('#id_brand_id').val(),
        'p_group_id': $('#id_group_id').val()
    };
