...
function save_and_show_report() {
    ...
    var report_data = { 'p_branch_code': $('#id_branch_code').val(), 'p_supplier_account': $('#id_account_number').val(), 'p_from_date': $('#id_from_date').val(), 'p_upto_date': $('#id_upto_date').val() };
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.form_is_valid) {
                ...
                account_number.textContent = "Select Supplier";
...
let w_tran_screen = 'SUPP_ACCOUNT';
