    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                var supp_name = document.getElementById('id_supp_name').value;
                var supp_mobile = document.getElementById('id_supp_mobile').value;
                var branch_code = document.getElementById('id_branch_code').value;

                var search_url = "/sales-supplier-api/?supp_name=" + supp_name + "&supp_mobile=" + supp_mobile + "&branch_code=" + branch_code;
