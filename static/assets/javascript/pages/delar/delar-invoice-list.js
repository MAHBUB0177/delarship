  ...
  function () {
    ...
    _createClass(fn_data_table, [{
      ...
      value: function table() {
        ...
        var search_url = "/delar-invoice-api/?invoice_number=" + invoice_number + "&branch_code=" + branch_code
          + "&invoice_from_date=" + invoice_from_date + "&invoice_upto_date=" + invoice_upto_date + "&employee_id=" + employee_id;
        ...
        table_data = $('#dt-invoice-list').DataTable({
          ...
          columns: [
            ...
            { data: 'total_quantity' },
            { data: 'bill_amount' },
            { data: 'total_sales_discount_amount' },
            { data: 'status' },
            {
              "data": null,
...
$(function () {
  $('#btnSearchStockMst').click(function () {
    ...
    if (invoice_number === "" & invoice_from_date === "" & employee_id === "" & invoice_upto_date === "") {
...
$(function () {
  ...
  $(function () {
    ...
    function view_invoice_details(id) {
      var url = "delar-invoice-details/" + id;
      $.ajax({
        url: url,
        type: "GET",
        data: {
