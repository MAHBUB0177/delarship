    ...
    function() {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const shift_id = '';
                const search_url = "/apihrm-shiftInfo-api?shift_id=" + shift_id;
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'shift_name' },
                        { data: 'office_id' },
                        { data: 'total_work_minute' },
                        { data: 'work_start_time_sec' },
                        { data: 'work_end_time_sec' },
                        { data: 'work_start_grace_time_sec' },
                        { data: 'work_end_time_grace_sec' },
                        { data: 'refresh_start_time_sec' },
                        { data: 'ot_time_start' },
                        { data: 'ot_time_end' },
                        { data: 'max_ot_hour' },
                        { data: 'duty_gap_time' },
                        { data: 'morning_ot_time' },
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.form_is_valid) {
                ...
                alert(data.success_message + " id:" + data.shift_id);
            } else {
                $('#page_loading').modal('hide');
